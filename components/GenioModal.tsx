    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-[540px] text-center"
        >
          <motion.div
            animate={{
              boxShadow: [
          ...
          <motion.p
            ...
            className="mb-3 text-[11px] uppercase tracking-[4px] text-[#6a5898]"
          >
            algo desperta
          </motion.p>
          ...
          <motion.h2
            ...
            className="mb-8 text-[clamp(19px,3.6vw,27px)] italic leading-relaxed text-[#f0ecff]"
          >
          ...
          {enviado ? (
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-[16px] italic text-[#c8a030]"
            >
